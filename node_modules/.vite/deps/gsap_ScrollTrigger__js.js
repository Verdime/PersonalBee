...
var ScrollTrigger2 = function() {
  ...
  ScrollTrigger3.enable = function enable() {
    ...
    if (gsap2) {
      ...
      _context = gsap2.core.context || _passThrough;
...
ScrollTrigger2.version = "3.11.2";
ScrollTrigger2.saveStyles = function(targets) {
  return targets ? _toArray(targets).forEach(function(target) {
    if (target && target.style) {
      var i = _savedStyles.indexOf(target);
      i >= 0 && _savedStyles.splice(i, 5);
      _savedStyles.push(target, target.style.cssText, target.getBBox && target.getAttribute("transform"), gsap2.core.getCache(target), _context());
    }
  }) : _savedStyles;
};
